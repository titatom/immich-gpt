...
If you expose Immich GPT to the internet (e.g. via a reverse proxy with SSL), set:
...
**Back up `/data`.**  It contains your user accounts, bucket config, prompt templates, all AI suggestions, and review decisions.
