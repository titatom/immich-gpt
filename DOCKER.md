...
| **Admin Password** | `choose-a-strong-password` *(minimum 8 characters)* |
...
| `ADMIN_PASSWORD` | *(empty)* | Initial password for the admin account (minimum 8 characters); required for a fresh install |
